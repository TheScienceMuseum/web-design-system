...
<Meta title="Science Museum Group: Web Design System" />
...
Read the Reference section, then see [Getting Started](?path=/docs/getting-started--docs) for how to integrate it into your project.
